...
- Estado S4.6.5.38:
  `scripts/migration/execute-controlled-lab-insert.mjs` existe con modo inicial
  fixture/no-network y fixtures sanitizadas. Requiere flags
...
- Estado S4.6.5.40:
  `execute-controlled-lab-insert.mjs` agrega `private-validate-no-network`.
  Exige payload fuera del repo y
...
- [x] Controlled lab insert executor private validate/no-network mode.
